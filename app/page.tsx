...
const campanhasBase = [
  ...
  { nome: "Kits de higiene", arrecadado: 100, meta: 150 },
  { nome: "Crianças assistidas", arrecadado: 300, meta: 350 },
  { nome: "Famílias cadastradas", arrecadado: 150, meta: 200 },
];
  ...
  return (
    <main className="page">
      <style>{`
        ...
        .info { background:#fff1f2; color:#9f1239; border-radius:14px; padding:12px 14px; margin-bottom:14px; font-weight:700; }
      ...
      <section className="container">
        ...
        <div className="grid4">
          <div className="card metric"><div className="metric-icon"><Users size={28} /></div><div><span>Famílias cadastradas</span><strong>{metricas.totalFamilias}</strong></div></div>
          <div className="card metric"><div className="metric-icon"><Baby size={28} /></div><div><span>Crianças assistidas</span><strong>{metricas.totalCriancas}</strong></div></div>
          <div className="card metric"><div className="metric-icon"><PackageCheck size={28} /></div><div><span>Solicitações de cesta</span><strong>{metricas.pedidosCesta}</strong></div></div>
          <div className="card metric"><div className="metric-icon"><Gift size={28} /></div><div><span>Solicitações de kit</span><strong>{metricas.pedidosKit}</strong></div></div>
        </div>
        ...
        {aba === "dashboard" && (
          <div className="grid2">
            <div className="card">
              <h2><BarChart3 size={24} /> Evolução dos atendimentos</h2>
        ...
        {aba === "familias" && (
          <div className="card">
            <div className="search"><Search size={20} /><input value={busca} onChange={(e) => setBusca(e.target.value)} placeholder="Buscar por responsável, bairro, necessidade ou status..." /></div>
            <table>
              <thead><tr><th>ID</th><th>Responsável</th><th>Bairro</th><th>Crianças</th><th>Necessidade</th><th>Prioridade</th><th>Status</th><th>Último atendimento</th></tr></thead>
        ...
        {aba === "campanhas" && (
          <div className="card">
            <h2><Gift size={24} /> Metas de campanhas</h2>
            {campanhas.map((item) => {
        ...
        {aba === "voluntarios" && (
          <div className="grid2">
            ...
            <div className="card">
              <h2><BarChart3 size={24} /> Participação em ações</h2>
              <ResponsiveContainer width="100%" height={300}>
